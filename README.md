...
3. Start by downloading or cloning the contents of this repository to your PHP server. Clone the files such that **sample-sso.php** is found in the same directory as the pages you wish to secure.
